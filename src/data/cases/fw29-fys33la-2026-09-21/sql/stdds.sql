...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 12:01:44') AND t.position_timestamp < TIMESTAMP('2026-09-21 13:01:44') AND t.common.latitude BETWEEN 39.773 AND 41.592 AND t.common.longitude BETWEEN -4.76 AND -3.254))
