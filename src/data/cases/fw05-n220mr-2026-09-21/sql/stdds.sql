...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 05:32:21') AND t.position_timestamp < TIMESTAMP('2026-09-21 06:32:21') AND t.common.latitude BETWEEN 59.479 AND 61.221 AND t.common.longitude BETWEEN 10.502 AND 13.319))
