...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 00:05:58') AND t.position_timestamp < TIMESTAMP('2026-09-21 01:05:58') AND t.common.latitude BETWEEN -23.267 AND -19.879 AND t.common.longitude BETWEEN -47.647 AND -46.167))
