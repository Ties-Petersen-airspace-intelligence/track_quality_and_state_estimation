...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 22:55:57') AND t.position_timestamp < TIMESTAMP('2026-09-21 23:55:57') AND t.common.latitude BETWEEN 34.137 AND 35.436 AND t.common.longitude BETWEEN -112.969 AND -111.675))
