...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 09:16:04') AND t.position_timestamp < TIMESTAMP('2026-09-21 10:16:04') AND t.latitude BETWEEN 42.798 AND 44.336 AND t.longitude BETWEEN 0.18 AND 2.417))
