...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 10:41:06') AND t.position_timestamp < TIMESTAMP('2026-09-21 11:41:06') AND t.common.latitude BETWEEN 40.751 AND 42.054 AND t.common.longitude BETWEEN -9.302 AND -7.912))
