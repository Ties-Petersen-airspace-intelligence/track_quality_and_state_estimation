...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 10:16:50') AND t.position_timestamp < TIMESTAMP('2026-09-21 11:16:50') AND t.latitude BETWEEN -35.044 AND -32.962 AND t.longitude BETWEEN -60.371 AND -57.879))
