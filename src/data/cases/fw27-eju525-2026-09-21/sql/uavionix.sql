...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 19:10:44') AND t.position_timestamp < TIMESTAMP('2026-09-21 20:10:44') AND t.common.latitude BETWEEN 40.392 AND 43.368 AND t.common.longitude BETWEEN 11.931 AND 15.297))
