...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 15:54:52') AND t.position_timestamp < TIMESTAMP('2026-09-21 16:54:52') AND t.common.latitude BETWEEN 39.81 AND 41.278 AND t.common.longitude BETWEEN -107.801 AND -106.497))
