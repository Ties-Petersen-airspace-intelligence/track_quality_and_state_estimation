...
WHERE DATE(t.position_timestamp) = '2026-09-22'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-22 09:48:49') AND t.position_timestamp < TIMESTAMP('2026-09-22 10:48:49') AND t.latitude BETWEEN 44.556 AND 45.865 AND t.longitude BETWEEN 4.321 AND 5.847))
