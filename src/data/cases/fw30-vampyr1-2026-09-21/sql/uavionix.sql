...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 19:00:06') AND t.position_timestamp < TIMESTAMP('2026-09-21 20:00:06') AND t.common.latitude BETWEEN 30.907 AND 33.016 AND t.common.longitude BETWEEN -115.287 AND -109.754))
