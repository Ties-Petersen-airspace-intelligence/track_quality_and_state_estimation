...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 15:01:29') AND t.position_timestamp < TIMESTAMP('2026-09-21 16:01:29') AND t.common.latitude BETWEEN 39.848 AND 42.011 AND t.common.longitude BETWEEN -5.253 AND -3.252))
