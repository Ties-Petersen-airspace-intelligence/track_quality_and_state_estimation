...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 08:12:01') AND t.position_timestamp < TIMESTAMP('2026-09-21 09:12:01') AND t.common.latitude BETWEEN 59.65 AND 64.117 AND t.common.longitude BETWEEN 4.099 AND 12.228))
