...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 00:12:43') AND t.position_timestamp < TIMESTAMP('2026-09-21 01:12:43') AND t.latitude BETWEEN 8.328 AND 11.796 AND t.longitude BETWEEN -79.854 AND -72.352))
