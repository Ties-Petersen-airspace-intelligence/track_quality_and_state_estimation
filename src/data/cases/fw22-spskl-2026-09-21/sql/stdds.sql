...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 07:36:17') AND t.position_timestamp < TIMESTAMP('2026-09-21 08:36:17') AND t.common.latitude BETWEEN 50.111 AND 51.157 AND t.common.longitude BETWEEN 19.321 AND 21.152))
