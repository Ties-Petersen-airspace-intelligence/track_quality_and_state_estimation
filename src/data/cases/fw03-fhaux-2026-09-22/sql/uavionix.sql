...
WHERE DATE(t.position_timestamp) = '2026-09-22'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-22 07:47:42') AND t.position_timestamp < TIMESTAMP('2026-09-22 08:47:42') AND t.common.latitude BETWEEN 44.896 AND 47.562 AND t.common.longitude BETWEEN 4.961 AND 6.958))
