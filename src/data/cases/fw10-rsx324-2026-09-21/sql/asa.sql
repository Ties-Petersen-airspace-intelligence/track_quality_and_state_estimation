...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.common.position_timestamp >= TIMESTAMP('2026-09-21 02:39:14') AND t.common.position_timestamp < TIMESTAMP('2026-09-21 03:39:14') AND t.common.latitude BETWEEN 46.228 AND 54.056 AND t.common.longitude BETWEEN 21.362 AND 23.169))
