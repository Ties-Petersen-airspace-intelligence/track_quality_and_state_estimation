...
WHERE DATE(t.position_timestamp) = '2026-09-22'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-22 01:46:49') AND t.position_timestamp < TIMESTAMP('2026-09-22 02:46:49') AND t.common.latitude BETWEEN 39.69 AND 40.752 AND t.common.longitude BETWEEN -112.269 AND -111.193))
