...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 14:52:17') AND t.position_timestamp < TIMESTAMP('2026-09-21 15:52:17') AND t.common.latitude BETWEEN 37.931 AND 39.667 AND t.common.longitude BETWEEN -108.397 AND -105.212))
