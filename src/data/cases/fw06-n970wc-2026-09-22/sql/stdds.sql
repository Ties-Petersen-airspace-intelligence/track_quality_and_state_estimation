...
WHERE DATE(t.position_timestamp) = '2026-09-22'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-22 00:18:55') AND t.position_timestamp < TIMESTAMP('2026-09-22 01:18:55') AND t.common.latitude BETWEEN 39.691 AND 41.145 AND t.common.longitude BETWEEN -112.514 AND -111.186))
