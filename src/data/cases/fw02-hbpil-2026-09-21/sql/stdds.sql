...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 14:52:58') AND t.position_timestamp < TIMESTAMP('2026-09-21 15:52:58') AND t.common.latitude BETWEEN 45.763 AND 47.09 AND t.common.longitude BETWEEN 4.349 AND 7.408))
