...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 06:30:38') AND t.position_timestamp < TIMESTAMP('2026-09-21 07:30:38') AND t.common.latitude BETWEEN 46.405 AND 48.092 AND t.common.longitude BETWEEN 6.93 AND 8.079))
