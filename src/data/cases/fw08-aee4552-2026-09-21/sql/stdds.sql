...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 06:02:42') AND t.position_timestamp < TIMESTAMP('2026-09-21 07:02:42') AND t.common.latitude BETWEEN 52.744 AND 61.604 AND t.common.longitude BETWEEN 22.216 AND 24.101))
