...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 21:32:23') AND t.position_timestamp < TIMESTAMP('2026-09-21 22:32:23') AND t.common.latitude BETWEEN 52.146 AND 56.132 AND t.common.longitude BETWEEN 12.137 AND 18.157))
