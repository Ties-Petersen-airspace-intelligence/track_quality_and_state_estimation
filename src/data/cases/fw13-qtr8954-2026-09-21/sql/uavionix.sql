...
WHERE DATE(t.position_timestamp) = '2026-09-21'
  AND ((t.position_timestamp >= TIMESTAMP('2026-09-21 16:06:05') AND t.position_timestamp < TIMESTAMP('2026-09-21 17:06:05') AND t.common.latitude BETWEEN 24.255 AND 25.933 AND t.common.longitude BETWEEN 51.106 AND 57.551))
