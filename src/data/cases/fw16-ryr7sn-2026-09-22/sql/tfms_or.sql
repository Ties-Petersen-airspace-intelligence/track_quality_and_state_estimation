...
WHERE DATE(t.position_timestamp) = '2026-09-22'
  AND ((t.common.position_timestamp >= TIMESTAMP('2026-09-22 03:29:51') AND t.common.position_timestamp < TIMESTAMP('2026-09-22 04:29:51') AND t.common.latitude BETWEEN 51.326 AND 57.131 AND t.common.longitude BETWEEN 10.102 AND 21.96))
