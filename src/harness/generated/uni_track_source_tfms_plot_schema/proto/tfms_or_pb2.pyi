...
class TFMSOceanicReportPlot(_message.Message):
    __slots__ = ("common", "fltd_message_attributes", "qualified_aircraft_id", "position_timestamp")
    ...
    def __init__(self, common: _Optional[_Union[_plot_pb2.Common, _Mapping]] = ..., fltd_message_attributes: _Optional[_Union[_common_pb2.FLTDMessageAttributes, _Mapping]] = ..., qualified_aircraft_id: _Optional[_Union[_common_pb2.QualifiedAircraftID, _Mapping]] = ..., position_timestamp: _Optional[int] = ...) -> None: ...
