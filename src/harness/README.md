...
- *Size*: fixed, with a slider, or by NACp or NIC, drawn as a filled circle of that radius in metres (the 95 % radius for NACp, the containment radius for NIC, from DO-260B).
